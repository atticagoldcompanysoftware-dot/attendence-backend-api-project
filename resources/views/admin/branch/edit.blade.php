            ...
            <div class="ps-3">
                <nav aria-label="breadcrumb">
                    <ol class="breadcrumb mb-0 p-0">
                        ...
                        <li class="breadcrumb-item active" aria-current="page">Edit Brach</li>
                    </ol>
                </nav>
            </div>
            <div class="ms-auto">
                            ...
                            <div class="row g-3">
                                ...
                                <div class="col-md-4">
                                    <div class="mb-3">
                                        ...
                                        <input class="form-control" type="text" name="area" placeholder="Enter Area"
                                            aria-label="default input example" value="{{ $data->area }}">
                                        @error('area')
                                            <span class="text-danger">{{ $message }}</span>
                                        @enderror
                                    </div>
                                ...
                                <div class="col-md-4">
                                    <div class="mb-3">
                                        ...
                                        <input class="form-control" type="text" name="city" placeholder="Enter City"
                                            aria-label="default input example" value="{{ $data->city }}">
                                        @error('city')
                                            <span class="text-danger">{{ $message }}</span>
                                        @enderror
                                    </div>
                                ...
                                <div class="col-md-4">
                                    <div class="mb-3">
                                        ...
                                        <input class="form-control" type="text" name="state" placeholder="Enter State"
                                            aria-label="default input example" value="{{ $data->state }}">
                                        @error('state')
                                            <span class="text-danger">{{ $message }}</span>
                                        @enderror
                                    </div>
                                ...
                                <div class="col-md-12">
                                    <div class="mb-3">
                                        ...
                                        <textarea class="form-control" name="addressline" aria-label="With textarea" placeholder="Enter Branch Address">{{ $data->addressline }}</textarea>
                                        @error('addressline')
                                            <span class="text-danger">{{ $message }}</span>
                                        @enderror
                                    </div>
